...
public class XmlResultParser {
	...
	private Word createWord(XmlPullParser pullParser) {
		...
		word.dp_message = getInt2(pullParser, "dp_message");
		word.total_score = getFloat(pullParser, "total_score");
		word.global_index = getInt2(pullParser, "global_index");
	...
	private int getInt2(XmlPullParser pullParser, String attrName) {
		String val = pullParser.getAttributeValue(null, attrName);
		if (null == val) {
			//return 0;
			return -1;
